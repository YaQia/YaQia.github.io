...
> Tips: 关于如何让Linux内核编译时生成`compile_commands.json`，请看我的[这一篇博客](/blogs/building_linux_kernel)
...
![`sched_ext`调度周期流程](./pic/sched_ext_flow.png)
